#!/usr/bin/env python3
"""
Properly fix FyersClient by adding missing methods
"""
...
'''
    ...
    content = content[:get_quotes_end] + new_methods + content[get_quotes_end:]
